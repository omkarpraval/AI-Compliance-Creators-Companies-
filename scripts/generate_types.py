...
with open("packages/shared-types/openapi.json", "w", encoding="utf-8") as f:
...
with open("packages/shared-types/index.ts", "w", encoding="utf-8") as f:
    f.write(ts_types)

print("Generated OpenAPI TypeScript definitions in packages/shared-types/index.ts")
